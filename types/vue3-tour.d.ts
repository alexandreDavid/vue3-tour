...
type PopperPlacement = 'auto' | 'bottom' | 'top' | 'right' | 'left' |
    'auto-start' | 'bottom-start' | 'top-start' | 'right-start' | 'left-start' |
    'auto-end' | 'bottom-end' | 'top-end' | 'right-end' | 'left-end';
...
interface EnabledNavigationKeys {
    /**
     * @defaultValue true
     */
    ESCAPE: boolean;
...
export interface VStepProps extends VNodeProps  {
    /**
     * The step definition
     */
    step: Step;
...
export interface VTourProps extends VNodeProps  {
    /**
     * Tour name.
...
export interface VTourSlotProps extends VNodeProps  {
    currentStep: number;
    steps: Step[];
    previousStep: CallbackWithCurrentStep;
    nextStep: CallbackWithCurrentStep;
